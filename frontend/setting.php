...
<body>
    ...
    <main class="main">
        <section class="form-container">
            ...
            <form action="./setting.php" method="post" enctype="multipart/form-data" class="form">
              ...
              <div class="input-box">
                ...
                <input type="text" placeholder="Enter full name" name="name" value="<?php echo $_SESSION["username"];?>" />
              </div>
              <div class="input-box">
              ...
              <div class="input-box">
                ...
                <input type="text" placeholder="Enter password" name="password" value="<?php echo $_SESSION["user_pass"];?>" />
              </div>
    ...
    <script src="./scripts/setting.js"></script>cr
